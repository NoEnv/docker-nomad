...
ENV NOMAD_VERSION=1.11.2 \
    PODMAN_DRIVER_VERSION=0.6.5-dev \
    HASHICORP_RELEASES=https://releases.hashicorp.com \
    GITHUB_RELEASES=https://github.com/zyclonite/nomad-driver-podman/releases
...
RUN microdnf -y --nodocs install gnupg2 iproute unzip shadow-utils dmidecode && \
    ...
    curl -sL -O ${GITHUB_RELEASES}/download/0.0.1/nomad-driver-podman_${PODMAN_DRIVER_VERSION}_linux_${ARCHITECTURE}.zip && \
